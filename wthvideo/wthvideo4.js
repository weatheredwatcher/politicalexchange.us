...
wthvideo.params = {
	...
	flv:"chantelpoliticalexchange3429.flv"};
...
function onlyOnce() {
if (document.cookie.indexOf("hasSeen4=true") == -1) {
var later = new Date();
later.setFullYear(later.getFullYear()+10);
document.cookie = 'hasSeen4=true;path=/;';
wthvideo.drawVideo();
}
}
...
if (wthvideo.params.autostart=="onceonly") {
	if (document.cookie.indexOf("hasSeen4=true") == -1) {
		var later = new Date();
		later.setFullYear(later.getFullYear()+10);
		document.cookie = 'hasSeen4=true;expires='+later.toGMTString();
		wthvideo.params.autostart = "yes";
		}
	else {
		wthvideo.params.autostart = "mute";
