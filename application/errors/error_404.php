...
<div id="contentwrap">
    ...
    <div id="stars">
    	...
    	<div id="locationOops" ><!-- Begin MailChimp Signup Form -->
...
<div id="mc_embed_signup">
 <h1 style="text-align:center; color:#FFFFFF; font-family:Tahoma, Geneva, sans-serif;font-weight:normal;margin-bottom:3px;"> Oops! This page does not exist</h1>	<p align="center" style="font-size:15px;font-weight: bold;margin-top:0px;">Try Again!</p>
